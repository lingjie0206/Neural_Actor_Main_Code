...
class SingleObjRenderingTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--load-rgb-name", type=str, default="rgb")
    ...
    def load_dataset(self, split, **kwargs):
        ...
        self.datasets[split] = Dataset(
            ...
            subsample_valid=self.args.subsample_valid if split == 'valid' else self.args.subsample_train,
            ...
            load_rgb_name=getattr(self.args, "load_rgb_name", "rgb")
        )
